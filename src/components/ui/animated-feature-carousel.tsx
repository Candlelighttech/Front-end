...
function FeatureCard({ children, step }: { children: React.ReactNode; step: number }) {
  ...
  return (
    ...
    >
      <div className="relative w-full overflow-hidden rounded-3xl border border-primary-accent/30 bg-card transition-colors duration-300">
            ...
            <ol className="flex w-full flex-wrap items-center justify-center gap-2" role="list">
                ...
                className={cn(
                  ...
                  isCurrent 
                    ...
                    : "bg-card text-muted-foreground hover:bg-primary-accent/10"
                )}
                ...
                <span className={cn(
                  ...
                  isCompleted 
                    ...
                    : isCurrent 
                      ...
                      : "bg-card text-muted-foreground group-hover:bg-primary-accent/10"
                )}>
                                    {isCompleted ? (
...
const defaultClasses = {
  img: "rounded-xl border border-primary-accent/20 shadow-lg shadow-primary/10",
